...
const About = () => {
  ...
  const sectionText = {
    english: {
      ...
      accent: " stories",
      subheading: "2 years ago, I began as a developer, consistently practicing, coding, and studying new technologies.",
    ...
    español: {
      ...
      accent: " historias",
      subheading: "Hace 2 años comencé como desarrollador, practicando, codificando y estudiando nuevas tecnologías.",
          ...
          <motion.div
            ...
            <div className='flex flex-1 xl:gap-x-6'>
              ...
              <div className='relative flex-1 after:w-[1px] after:h-full after:absolute after:top-0 after:right-0'>
                <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2'>
                  <CountUp start={-8} end={12} duration={10} />
                </div>
                <div className='text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]'>
                  {text.projects}
                </div>
